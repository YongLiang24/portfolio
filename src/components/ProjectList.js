  ...
  return(
    <div style={{textAlign: "center"}}>
      <List   relaxed size="huge">
        ...
        {/*Project 1  */}
        <Modal trigger={<List.Item as="a" >Metro Pizza</List.Item>} size="large" closeIcon style={{textAlign: "center", fontSize: "1.3em"}}>
          ...
          <Modal.Content>
            <Modal.Description>
              ...
              <p>Try it at: <a href="https://yongliang24.github.io/frontend_customers_metro_pizza/" target="_blank" rel="noopener noreferrer">Metro Pizza Link</a> <br/><br/>Administrator site: <a href="https://yongliang24.github.io/frontend_admin_metro_pizza/" target="_blank" rel="noopener noreferrer">Metro Pizza Administrator</a></p> <p>Github Repo: <a href="https://github.com/YongLiang24/frontend_customers_metro_pizza" target="_blank" rel="noopener noreferrer">Metro Pizza Github</a></p>
              </Modal.Description>
            </Modal.Content>
            <Modal.Content>
          ...
          {/*Project 2  */}
          <Modal trigger={<List.Item as="a" >Pictionary Online</List.Item>} size="large" style={{textAlign: "center", fontSize: "1.3em"}} closeIcon>
            ...
            <Modal.Content>
              <Modal.Description>
                ...
                <p>Try it at: <a href="https://yongliang24.github.io/pictionary-online/#/" target="_blank" rel="noopener noreferrer">Pictionary Link</a></p>
                <p>Github Repo: <a href="https://github.com/YongLiang24/pictionary-online" target="_blank" rel="noopener noreferrer">Pictionary Github</a></p>
              </Modal.Description>
            </Modal.Content>
            <Modal.Content>
          ...
          {/*Project 3  */}
          <Modal trigger={<List.Item as="a" >Translatr</List.Item>} size="large" closeIcon style={{textAlign: "center", fontSize: "1.3em"}}>
            ...
            <Modal.Content>
              <Modal.Description>
                ...
                <p>Try it at: <a href="https://yongliang24.github.io/translatr-frontend/" target="_blank" rel="noopener noreferrer">Translatr Link</a></p>
                <p>Github Repo: <a href="https://github.com/YongLiang24/translatr-frontend" target="_blank" rel="noopener noreferrer">Translatr Github</a></p>
              </Modal.Description>
            </Modal.Content>
            <Modal.Content>
          ...
          <Modal trigger={<List.Item as="a" >AxeMan X</List.Item>} size="large" closeIcon style={{textAlign: "center", fontSize: "1.3em"}}>
            ...
            <Modal.Content>
              <Modal.Description>
                ...
                <p>Try it at: <a href="https://play.google.com/store/apps/details?id=com.AxeMan88.Test&hl=en_US" target="_blank" rel="noopener noreferrer">AxeMan X Android</a></p>
              </Modal.Description>
            </Modal.Content>
            <Modal.Content>
          ...
          {/* Project 2 */}
          <Modal trigger={<List.Item as="a" >Burger Sim</List.Item>} size="large" closeIcon style={{textAlign: "center", fontSize: "1.3em"}}>
            ...
            <Modal.Content>
              <Modal.Description>
                ...
                <p>Try it at: <a href="https://play.google.com/store/apps/details?id=com.AxeMan88.Test&hl=en_US" target="_blank" rel="noopener noreferrer">Burger Sim Android</a></p>
              </Modal.Description>
            </Modal.Content>
            <Modal.Content>
